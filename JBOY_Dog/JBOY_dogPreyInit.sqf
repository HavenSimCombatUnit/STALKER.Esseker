...
_markerDistance   = 7;  // Minimum distance prey must travel before we mark a new position.  Keeps our arrays smaller.  Originally was 10.  Tried 3, but so close together that slowed down dog tracking
...
_prey setVariable ["trackedByDog",objNull,true];
_prey setVariable ["trail",[],true ];             // Array of scent markers dropped by prey
_prey setVariable ["trailIsActive",true,true ];             // Array of scent markers dropped by prey
