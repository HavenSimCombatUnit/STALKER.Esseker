...
VD_Land_Blacklist_Area = ["VD_Debug_BlacklistArea_1"];
...
VD_Coast_Blacklist_Area = ["VD_SW_BlacklistArea_1"];
//... = []; empty brackets means that you want to place NO marker
//
...
VD_DBO_Horses_AmountOfSpawns = 5; //amount of horses to spawn, set to 0 to disable

/*Section 2.9: Feral dog pack by JBDOG*/
VD_AllowJBDOG = true; // enable jbdog scripts
