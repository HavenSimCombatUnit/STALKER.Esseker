...
_pos1 = [getPosATL _player, 500, 1200, 0, 0, 0.9	, 0,VD_Land_Blacklist_Area] call BIS_fnc_findSafePos; // the first two numbers are the minimum and maximum range that the animals spawn related to the players position
